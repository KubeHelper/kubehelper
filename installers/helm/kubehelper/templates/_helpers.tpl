...
helm.sh/chart: {{ include "kubehelper.chart" . }}
...
*/}}
{{- define "kubehelper.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "kubehelper.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
