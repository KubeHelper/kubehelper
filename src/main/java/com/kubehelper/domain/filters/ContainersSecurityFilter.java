 ...
 * @author JDev
 */
public class ContainersSecurityFilter {
    ...
    public ContainersSecurityFilter() {
    }
    ...
    public ContainersSecurityFilter setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ContainersSecurityFilter setSelectedResourcePropertyFilter(String selectedResourcePropertyFilter) {
    ...
    public ContainersSecurityFilter setResourcePropertiesFilter(ListModelList<String> resourcePropertiesFilter) {
    ...
    public ContainersSecurityFilter setAdditionalInfo(String additionalInfo) {
    ...
    public ContainersSecurityFilter setNamespacesFilter(ListModelList<String> namespacesFilter) {
    ...
    public ContainersSecurityFilter setResourceTypesFilter(ListModelList<String> resourceTypesFilter) {
    ...
    public ContainersSecurityFilter setResourceNamesFilter(ListModelList<String> resourceNamesFilter) {
    ...
    public ContainersSecurityFilter setSelectedNamespaceFilter(String selectedNamespaceFilter) {
    ...
    public ContainersSecurityFilter setSelectedResourceTypeFilter(String selectedResourceTypeFilter) {
    ...
    public ContainersSecurityFilter setSelectedResourceNameFilter(String selectedResourceNameFilter) {
