 ...
 * @author JDev
 */
public class PodsSecurityFilter {
    ...
    public PodsSecurityFilter setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public PodsSecurityFilter setSelectedResourcePropertyFilter(String selectedResourcePropertyFilter) {
    ...
    public PodsSecurityFilter setResourcePropertiesFilter(ListModelList<String> resourcePropertiesFilter) {
    ...
    public PodsSecurityFilter setAdditionalInfo(String additionalInfo) {
    ...
    public PodsSecurityFilter setNamespacesFilter(ListModelList<String> namespacesFilter) {
    ...
    public PodsSecurityFilter setResourceTypesFilter(ListModelList<String> resourceTypesFilter) {
    ...
    public PodsSecurityFilter setResourceNamesFilter(ListModelList<String> resourceNamesFilter) {
    ...
    public PodsSecurityFilter setSelectedNamespaceFilter(String selectedNamespaceFilter) {
    ...
    public PodsSecurityFilter setSelectedResourceTypeFilter(String selectedResourceTypeFilter) {
    ...
    public PodsSecurityFilter setSelectedResourceNameFilter(String selectedResourceNameFilter) {
