 ...
 * @author JDev
 */
public class PodsSecurityPoliciesSecurityFilter {
    ...
    public PodsSecurityPoliciesSecurityFilter() {
    }
    ...
    public PodsSecurityPoliciesSecurityFilter setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public PodsSecurityPoliciesSecurityFilter setSelectedResourcePropertyFilter(String selectedResourcePropertyFilter) {
    ...
    public PodsSecurityPoliciesSecurityFilter setResourcePropertiesFilter(ListModelList<String> resourcePropertiesFilter) {
    ...
    public PodsSecurityPoliciesSecurityFilter setAdditionalInfo(String additionalInfo) {
    ...
    public PodsSecurityPoliciesSecurityFilter setNamespacesFilter(ListModelList<String> namespacesFilter) {
    ...
    public PodsSecurityPoliciesSecurityFilter setResourceTypesFilter(ListModelList<String> resourceTypesFilter) {
    ...
    public PodsSecurityPoliciesSecurityFilter setResourceNamesFilter(ListModelList<String> resourceNamesFilter) {
    ...
    public PodsSecurityPoliciesSecurityFilter setSelectedNamespaceFilter(String selectedNamespaceFilter) {
    ...
    public PodsSecurityPoliciesSecurityFilter setSelectedResourceTypeFilter(String selectedResourceTypeFilter) {
    ...
    public PodsSecurityPoliciesSecurityFilter setSelectedResourceNameFilter(String selectedResourceNameFilter) {
