 ...
 * @author JDev
 */
public class ServiceAccountsSecurityFilter {
    ...
    public ServiceAccountsSecurityFilter() {
    }
    ...
    public ServiceAccountsSecurityFilter setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ServiceAccountsSecurityFilter setSelectedResourcePropertyFilter(String selectedResourcePropertyFilter) {
    ...
    public ServiceAccountsSecurityFilter setResourcePropertiesFilter(ListModelList<String> resourcePropertiesFilter) {
    ...
    public ServiceAccountsSecurityFilter setAdditionalInfo(String additionalInfo) {
    ...
    public ServiceAccountsSecurityFilter setNamespacesFilter(ListModelList<String> namespacesFilter) {
    ...
    public ServiceAccountsSecurityFilter setResourceTypesFilter(ListModelList<String> resourceTypesFilter) {
    ...
    public ServiceAccountsSecurityFilter setResourceNamesFilter(ListModelList<String> resourceNamesFilter) {
    ...
    public ServiceAccountsSecurityFilter setSelectedNamespaceFilter(String selectedNamespaceFilter) {
    ...
    public ServiceAccountsSecurityFilter setSelectedResourceTypeFilter(String selectedResourceTypeFilter) {
    ...
    public ServiceAccountsSecurityFilter setSelectedResourceNameFilter(String selectedResourceNameFilter) {
