...
public class EventsVM implements EventListener {
...
//        add(ENV_VARIABLE);
//    }};
    private ListModelList<EventResult> eventResults = new ListModelList<>();
    ...
    public void search() {
        ...
        eventsService.search(eventsModel.getSelectedNamespace(), searchModel, selectedResources);
