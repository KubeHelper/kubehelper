...
}();"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("livescript",(()=>{"use strict"
...
returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("puppet",(()=>{"use strict";return e=>{
...
relevance:0},n]}],relevance:0}]}}})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
},e.REGEXP_MODE,e.HASH_COMMENT_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
})).join("")}return n=>{
var a,i="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",s={
...
subLanguage:"ruby"}}]})})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("groovy",(()=>{"use strict";function e(e,n={}){
...
excludeBegin:!0,end:a+":",relevance:0}],illegal:/#|<\//};var l}})());hljs.registerLanguage("scss",(()=>{"use strict";return e=>{var t="@[a-z-]+",i={
...
end:/$/}]})})());hljs.registerLanguage("dos",(()=>{"use strict";return e=>{
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("moonscript",(()=>{"use strict";return e=>{const n={
...
className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("dart",(()=>{"use strict";return e=>{const n={
...
},e.C_NUMBER_MODE,{className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("scala",(()=>{"use strict";return e=>{const n={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("livecodeserver",(()=>{"use strict";return e=>{const r={
...
illegal:";$|^\\[|^=|&|\\{"}}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
